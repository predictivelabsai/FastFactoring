...
Сформировано 2026-07-26 · Доступно на **factorio.co.uk**
...
- Основано на настраиваемых лимитах портфеля и правилах диверсификации.

---

<p class="eyebrow">Приложение поставщика · AI-origination</p>

## От документа-счёта до заявки на финансирование

![Загрузка и AI-извлечение данных счёта](img/ru-19-invoice-upload.png)
