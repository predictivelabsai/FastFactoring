...
SLIDES = [
    ...
    },
    {
        ...
        "bullets": {
            ...
            "ru": [
                "Factorio AI — основное рабочее место поставщика: счёт PDF, изображение, JSON или текст прикрепляется скрепкой в чате.",
                "Цифровые PDF преобразуются в Markdown локально; xAI-зрение используется только для сканов.",
                "В чате показаны стоимость счёта, процент и сумма выплаты сегодня, срок и месячная стоимость; выписка или Open Banking необязательны.",
                "Принятие оферты создаёт заявку и одностраничный синтетический договор Factorio Ltd с извлечённым поставщиком.",
            ],
        },
    },
    {
